...
How it works (pipeline)
    ...
    Retrieve: embedding similarity fetches top‑K candidates.
    Ambiguity gate: short/generic queries skip rerank.
    Rerank: /api/rerank scores candidates.
    Gates: item/domain mismatch ⇒ score 0 + zero_reason.
    Sort: positives first; rejects tiered, then similarity; stable tie-of-ties.
    Explain: FACTS show item/domain decisions and reasons.
